...
if (isset($_SESSION['sessionAccessToken'])) {
    ...
    //print_r($accessToken->getAccessTokenExpiresAt());
    ...
    $date2=date_create($accessToken->getAccessTokenExpiresAt());

    if($date2 >$date1){
        $HOST='https://api.salescontrolcenter.com';
        $url = $HOST . '/_qbSaveToken.php';
        $data =array(
    ...
    $info=array(
        ...
        'accessTokenKey' =>$accessToken->getAccessToken(),
        'refreshTokenKey' => $accessToken->getRefreshToken(),
        'QBORealmID' => "4620816365025654070",
        'baseUrl' => "Development"
    );
