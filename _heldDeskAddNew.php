...
$EXPECTED = array('token','subject','problem','form',
    'status','assign_to','contactID');
...
if(!$isAuth){
    ...
    if(!$errObj['error']){
        ...
        $result = $Object->addNewHelpDesk($screenshot,$subject,$problem,$form,$status,$assign_to,$contactID);
        ...
        if(is_numeric($result) && $result){
            ...
            $errnote =$Object->add_notes_new($notes,$contactID,$result);
            $ret = array('SAVE'=>'SUCCESS','ERROR'=>'', 'UPLOAD'=>$upload,'ID'=>$result,
                'err_note'=>$errnote);
        } else {
            ...
            $Object->err_log("HelpDesk",$info,0);
        }
