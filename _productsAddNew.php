...
include_once '_qbviacurl.php';
    ...
    $EXPECTED = array('token','product_notes','product_tags','product_taxable','product_updated_by',
                ...
                if(is_numeric($result) && $result){
                    ...
                    if(isset($rsl["CreatedId"])){
                        if(is_numeric($rsl["CreatedId"]) && !empty($rsl["CreatedId"])){
                            $rsl_customer= $Object->updateItemRefIntoProductTable($rsl["CreatedId"],$result);
                        }else{
