...
//require('phpToPDF.php');
    ...
    $EXPECTED = array('token','warranty_address1','warranty_address2','warranty_buyer_agent_id','warranty_buyer_id','warranty_city',
        ...
        'warranty_submitter','warranty_submitter_type','contract_overage','comefrom');
        ...
        if(!$errObj['error']){
            ...
            if(is_numeric($result) && $result){
                    ...
                    foreach($pro_ids_temp as $item){
                        ...
                        if(count($prodOption)>0){
                            if(strtolower($prodOption[0]['product_tags']) =='eagle'){
                                ...
                                $prodOption[0]['prod_price'] =number_format($prodOption[0]['prod_price'],2,".",",");
							  ...
							  <td width="30%" style="border-right: 1px solid black; border-left: 1px solid black; padding:5px" align="right">$' . $prodOption[0]['prod_price'] . '</td>
							</tr>';
                            }
                        }
                    }
                ...
                if ($payment_type == 'Card'){
                    $odTotal = $oTotal;
                    $odTotal =number_format($odTotal,2,".",",");
                    $payment_made = '<tr align="center">
							  <td colspan="2" style="border: 1px solid black;" align="right"><strong></strong></td>
								<td width="30%" style="border: 1px solid black; padding:5px" align="right">Subtotal:  $' . $odTotal . '</td>
							</tr>
						<tr align="center">
							  <td colspan="2" style="border: 1px solid black;" align="right"><strong></strong></td>
								<td width="30%" style="border: 1px solid black; padding:5px" align="right">Payment Received:  ($' . $odTotal . ')</td>
							</tr>';
                    $oTotal= 0;
