...
include_once './lib/class.claim.php';
    $Object = new Claim();
    $EXPECTED = array('token','ID','claim_ID','warranty_id','person','date_time','jwt','private_key');
    ...
    if(!empty($ID)){
        ...
        if(!$isAuth){
            ...
            if($isAuth['AUTH']){
                ...
                if(!$errObj['error']){
                    $result = $Object->upClaimTransaction($ID,$claim_ID,$claim_amount,$person,$date_time,$warranty_id);
                    ...
                    if(is_numeric($result) &&  $result){
                        ...
                        $Object->err_log("ClaimTransaction",$info,$ID);
