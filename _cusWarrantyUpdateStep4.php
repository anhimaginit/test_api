...
include_once './lib/class.cus_warranty.php';
    ...
    $EXPECTED = array('token','ID','additional_person_infor_firstname','additional_person_infor_lastname',
    ...
    if(!$isAuth){
        ...
        $isAuth['AUTH']=true;
        if($isAuth['AUTH']){
            $result = $Object->updateCusWarrStep4($ID,$additional_person_infor_firstname,$additional_person_infor_lastname,
                $additional_person_infor_email);
