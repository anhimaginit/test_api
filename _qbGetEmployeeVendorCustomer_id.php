...
if(count($token_info)>0){
    ...
    $ret = $ObjectVC->qbGetEmployeeVendorCustomer_id($dataService,$id,$type);
    if(isset($ret['primary_state'])){
        $ret['primary_state']  = $Object->stateNameToKey($ret['primary_state']);
    }
