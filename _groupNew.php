...
include_once './lib/class.group.php';
    ...
    $EXPECTED = array('token','department','group_name','role','users','parent_group','parent_id',
        'jwt','private_key');
...
if(!$isAuth){
    ...
    if($isAuth['AUTH']){
        ...
        if(!$errObj['error']){
            ...
            $result = $Object->addGroup($department,$group_name,$role,$users,$parent_group,$parent_id);
